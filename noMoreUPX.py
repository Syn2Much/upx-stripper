...
#                                sintax@exploit.im
UPX_STRINGS = [
    # UPX signatures that DON'T break binaries when nulled
    b"$Id: UPX ",
    b'UPX!',
    ...
    b"NRV2E",
    b"DLY",
    # UPX version strings - safe to null
    b"UPX 0.",
    b"UPX 1.",
    b"UPX 2.",
    b"UPX 3.",
    b"UPX 4.",
    b"UPX 5.",
    # UPX website and metadata
    b"upx.sf.net",
    b"upx.github.io",
    b"UPX_MAGIC",
    b"UPX_HEADER",
    # Hex patterns (partial matches only)
    b"UPX",
    # Copyright notices
    b"Copyright (C) 1996-",
    b"Markus Oberhumer",
...
def fuzz_file(filename):
    ...
    for upx_str in UPX_STRINGS:
        new_data = new_data.replace(upx_str, b'\x00' * len(upx_str)) #null them bitches
